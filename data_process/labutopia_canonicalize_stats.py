...
Usage:
  python -m data_process.labutopia_canonicalize_stats  # from the repo root \\
      --src /path/to/data/LabUtopia/Level3_TransportBeaker/meta/stats.json \\
      --dst /path/to/data/LabUtopia/Level3_TransportBeaker/meta/stats_canonical_grip.json \\
      --gripper-dim 7 \\
      --max-width 0.04
"""
