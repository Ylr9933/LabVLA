...
/path/to/pretrain_data/robocoin is merged from 16+ source robots
...
"""
from src.schema.blueprint import MultiChannelBlueprint, StateActionChannel
...
SCHEMA = MultiChannelBlueprint(
    ...
    # gripper_open_scale_* is a 0-1 normalized open scale (already canonicalized
    # by the upstream merge); semantically open_fraction.
