...
``/path/to/pretrain_data/agibot_world_beta_lerobot/agibotworld/task_NNN``.
...
``Qwen3_VLProcessorTransformFn`` 3-camera limit.
...
from src.schema.arm_layout import ArmCount, ArmLayoutSpec
...
SCHEMA = DatasetSchema(
    ...
    # Effector position dim 1 is a 0..1 open scale; slot 0 is essentially zero
    # in this dataset. Treat as open_fraction (compatible with oxe-auge
    # open_fraction at the canonicalization boundary).
